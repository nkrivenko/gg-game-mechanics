...
namespace eosio {
   ...
   class [[eosio::contract("eosio.token")]] token : public contract {
      public:
         ...
         /**
          * Allows `from` account to transfer to `to` account the certain quantity of `quantities` tokens.
          * `to` account is debited and `from` is credited with each of `quantities` token.
          * 
          * @param from - the tokens sender,
          * @param to - the tokens receiver,
          * @param quantities - the quantities of tokens to be transferred,
          * @param memo - the memo string to accompany the transaction.
          */
         [[eosio::action]]
         void transfers( const name& from, const name& to, const std::vector<asset>& quantities, const string& memo );

         [[eosio::action]]
         void burntransfer( const name& from, const name& to, const std::vector<asset>& quantities, const int16_t transfer_percent, const string& memo );

         [[eosio::action]]
         void addminter( const name& new_minter );

         [[eosio::action]]
         void remminter( const name& old_minter );
         ...
         using addminter_action = eosio::action_wrapper<"addminter"_n, &token::addminter>;
         using remminter_action = eosio::action_wrapper<"remminter"_n, &token::remminter>;
         using burntransfer_action = eosio::action_wrapper<"burntransfer"_n, &token::burntransfer>;
      private:
         ...
         inline void check_minter() const;
   };
